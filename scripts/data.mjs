...
export const profile = {
  ...
  linkedin: "https://www.linkedin.com/in/bishnu-prasad-kar-600092317/",
...
export const publications = [
  { title: "Entropy-Optimized Hybrid Thresholding for Retinal Vessel Segmentation", venue: "SPARK-2K26 Research Conclave, GIET Bhubaneswar", year: "2026" },
  { title: "Scalable Hadoop/Spark Analysis on NYC TLC Dataset", venue: "National Conference on Computing 4.0 (NCCENGT-2025)", year: "2025" },
  { title: "Multiplexer-Based Controller for Modular ALU Design", venue: "Intl. Conference on Semiconductor Technologies and Renewable Energy (ICSTRE-2024)", year: "2024" },
];

export const awards = [
  { title: "1st place · Floodwatch", event: "Model Fiesta, Suravi 2K26" },
  { title: "3rd place · CycleSense", event: "ReFlow Hackathon, IIT Bhubaneswar" },
  { title: "Merit certificate, 81.6%", event: "Quantum Computing, IIT Roorkee & C-DAC" },
];

export const certifications = [
  { id: "nvidia", name: "Deep Learning, CNNs & NLP", issuer: "NVIDIA Deep Learning Institute", href: `${SITE}/certificates/nvidia-deep-learning.pdf` },
...
export const journey = [
  ...
  { year: "2025", note: "Moved from circuits to models", milestones: [
    ...
    { date: "Sep 2025", kind: "build", title: "Soil-to-Shelf for Smart India Hackathon", detail: "Built the Hyperledger Fabric layer that traces herbs from farm to shelf." },
    ...
    { date: "2025", kind: "paper", title: "Scalable Hadoop/Spark analysis of NYC taxi data", detail: "Presented at the National Conference on Computing 4.0 (NCCENGT-2025)." },
  ...
  { year: "2026", note: "Agents, explainability and quantum", milestones: [
    ...
    { date: "Feb 2026", kind: "award", title: "CycleSense takes 3rd at ReFlow", detail: "IIT Bhubaneswar's ReFlow Hackathon, with an IoT and AI platform for menstrual health." },
    ...
    { date: "2026", kind: "paper", title: "Entropy-optimized thresholding for retinal vessel segmentation", detail: "Presented at the SPARK-2K26 Research Conclave, GIET Bhubaneswar." },
    { date: "Jun 2026", kind: "work", title: "Generative AI Intern", detail: "CTTC, Ministry of MSME. LLM, RAG, LangChain and Hugging Face applications." },
    { date: "Jul 2026", kind: "learn", title: "Completed Boot.dev backend engineering", detail: "Finished the full track after twelve months." },
    { date: "Aug 2026", kind: "build", title: "Qubitscope for Smart India Hackathon 2026", detail: "With Team Creative Cartel: an interactive quantum lab backed by real Qiskit Aer simulations." },
  ] },
